...
mkdir /home/glbrc.org/kjkibler/cyanoSTRONG/krys/analysis/STRONG/VULCA_20/$sampleID


$SAMTOOLS fastq -@ 8 bt2/$sampleID.sorted.onlymap.bam \
    -1 /home/glbrc.org/kjkibler/cyanoSTRONG/krys/analysis/STRONG/VULCA_20/${sampleID}/${sampleID}.1.fastq.gz \
    -2 /home/glbrc.org/kjkibler/cyanoSTRONG/krys/analysis/STRONG/VULCA_20/${sampleID}/${sampleID}.2.fastq.gz \
