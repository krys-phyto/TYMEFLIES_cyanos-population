...
cd /home/glbrc.org/kjkibler/cyanoSTRONG/krys/analysis/STRONG/run2/MCYST_2/
...
$SAMTOOLS fastq -@ 8 $maps \
    -1 /home/glbrc.org/kjkibler/cyanoSTRONG/krys/analysis/STRONG/run2/MCYST_2/${sampleID}/${sampleID}.1.fastq.gz \
    -2 /home/glbrc.org/kjkibler/cyanoSTRONG/krys/analysis/STRONG/run2/MCYST_2/${sampleID}/${sampleID}.2.fastq.gz \
...
/mnt/bigdata/bifxapps/bbmap-38.32/filterbyname.sh in=$sampleID/${sampleID}.1.fastq.gz \
                                                  ...
                                                  names=/home/glbrc.org/kjkibler/cyanoSTRONG/krys/analysis/instrain/cyano_diamond_50/instrain-92ANI/output/diamond_50/files/STRONG_reads/MCYST_2/${sampleID}_filtered.reads
